...
./examples/archipelago-client $base_dir/conf-archipelago/hotstuff.gen.conf $base_dir/log/client$1.order.log  $base_dir/log/client$1.exec.log --cid $1 --iter -1 --max-async 4
